...
<li class="nav-item">
  ...
  <li class="nav-item">
    ...
    <div class="col-sm-9">
      <h2><small>Kemaskini Soalan dan Jawapan</small>
      @if (session('status'))
      ...
      <table class="table table-striped">
             ...
             @foreach($questions as $question)
                ...
                <td scope="row">{{ $questions->firstItem() + $loop->index }}</td>
                    ...
                    <td>  <a href="{{url('admin/questionUpdate/'.$question->id)}}" class="btn btn-primary">&nbsp Kemaskini Soalan&nbsp</a> <a href="{{url('admin/questionAddAnswer/'.$question->id)}}" class="btn btn-primary"> Kemaskini Jawapan</a> </td>
  </tr>
  @endforeach   
</table>
{{ $questions->links() }}
