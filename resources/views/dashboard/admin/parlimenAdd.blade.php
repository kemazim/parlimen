...
<html lang="en">
<head>
  <title>Tambah Parlimen Baru</title>
  <meta charset="utf-8">
...
<li class="nav-item">
    ...
    <div class="col-sm-9">
      <h2><small>Sila Isi Nama Parlimen Baru</small></h2>
      <hr>
      @if (session('status'))
...
<div class="card-body">
    <form method="POST" action="parlimenSave"  enctype="multipart/form-data">
        @csrf
                      <label for="nama" class="col-md-4 col-form-label text-md-end">{{ __('Nama Parlimen Baru  :') }}</label>
                      <input type="text" name="nama" placeholder="Sila isi nama Parlimen" value=""> <br> <br>

                     
                      
                      <br><br>
      <button type="submit" class="btn btn-primary"> Tambah Parlimen</button>
      <br><br>
    </div>
  </div>
</div>
