...
<html lang="en">
<head>
  <title>Kemaskini Yang Berhormat</title>
  <meta charset="utf-8">
...
<div class="container-fluid">
  <div class="row content">
    <div class="col-sm-2 sidenav">
      <h3>Kemaskini Yang Berhormat</h3>
      <hr>
...
<li class="nav-item">
    ...
    <div class="col-sm-9">
      <h2><small>Sila Kemaskini Maklumat Yang Berhormat</small></h2>
      <hr>
      @if (session('status'))
...
<div class="card-body">
    <form method="POST" action="{{ url('admin/ybUpdateSave/'.$yb->id) }}"  enctype="multipart/form-data">
        @csrf
        @method('PUT')
                      <label for="nama" class="col-md-4 col-form-label text-md-end">{{ __('Nama Yang Berhormat  :') }}</label>
                      <input type="text" name="nama" placeholder="Sila isi nama Yang Berhormat" value="{{$yb['nama']}}"> <br> <br>

                      <label for="nama_parlimen" class="col-md-4 col-form-label text-md-end">{{ __('Nama Parlimen :') }}</label>
                      <input type="text" name="nama_parlimen" placeholder="Sila isi nama Parlimen" value="{{$yb['nama_parlimen']}}"></textarea>
                     <br> <br>

                     
                     <br><br>
                      <div class="form-group mb-3">
                            <button type="submit" class="btn btn-primary" name="action" onclick="return confirm('Kemaskini Yang Berhormat?')">Kemaskini Yang Berhormat</button>
