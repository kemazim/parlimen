...
<div class="container-fluid">
  <div class="row content">
    <div class="col-sm-2 sidenav">
      <h3>Kemaskini &nbsp &nbsp &nbsp Soalan</h3>
      <hr>
...
<li class="nav-item">
    ...
    <div class="col-sm-9">
      <h2><small>Sila Kemaskini Soalan</small></h2>
 
      <div class="card">

<div class="card-body">
    <form method="POST" action="{{ url('admin/questionUpdateSave/'.$question->id) }}"  enctype="multipart/form-data">
        @csrf
        @method('PUT')
                    ...
                    <br> <br>
                     ...
                     <br> <br>
                      ...
                      <label for="yb" class="col-md-4 col-form-label text-md-end">{{ __('Yang Berhormat :') }}</label>
                      <input type="text" name="yb" id="yb" value="{{$question->yangBerhormat->nama}}" readonly="readonly"><br> <br>
                      ...
                      <div class="form-group mb-3">
                            <button type="submit" class="btn btn-primary" name="action" onclick="return confirm('Simpan kemaskini soalan?')">Kemaskini Soalan</button>
