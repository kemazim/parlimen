...
{ 
    function index()  
    {
        ...
        return view('dashboard.coordinator.dashboard',['chart'=>$data,'chart2'=>$data2] );
    }
    ...
    function editProfile(Request $request,$id) {
        $user = User::find($id);
        return view('dashboard.coordinator.editProfile', compact('user'));
    }
    function updateProfile(Request $request,$id) {
        ...
        $user->update();
        return redirect('/coordinator/profile')->with('status',"Kemaskini berjaya");
    }
    ...
    function questionList(Request $request)
    {
        ...
        return view('dashboard.coordinator.questionList', compact('questions'));
    }
    ...
    public function viewJawapan($id)
    {
        ...
        return view('dashboard.coordinator.viewJawapan', compact('question'));
    ...
    {
        $question = Question::where('status', 2)->get();
        return view('dashboard.coordinator.questionEdit', ['question' => $question]);
    }

    function questionAddAnswer($id)
    {
        $question = Question::find($id);
        return view('dashboard.coordinator.questionAddAnswer', compact('question'));
    } 
    function questionSaveAnswer(Request $req, $id)
    {
        ...
        return redirect('/coordinator/questionEdit')->with('status', "Jawapan telah berjaya ditambah");
    }
}
